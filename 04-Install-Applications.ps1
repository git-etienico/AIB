...
#region Foxit Reader
try {
    Start-Process -filepath msiexec.exe -Wait -ErrorAction Stop -ArgumentList '/i', 'c:\temp\FoxitReader1011_enu_Setup.msi', '/quiet', 'ADDLOCAL="FX_PDFVIEWER"'
...
#region Notepad++
try {
    Start-Process -filepath msiexec.exe -Wait -ErrorAction Stop -ArgumentList '/i', 'Notepad++7_8_9.msi', '/qn'
